...
class CafeFCrawler(BaseNewsCrawler):
    """Crawl financial news from cafef.vn via RSS feeds."""
    ...
    def __init__(
        ...
        super().__init__(client=client, robots_checker=robots_checker, source_name="cafef")
    ...
    def parse_article_page(self, url: str, html: str) -> str:
        """Extract article body from CafeF HTML."""
